...
export default function TermsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-3 py-5 sm:px-4 lg:py-8">
      ...
      <h1 className="mt-3 text-[24px] font-black text-[#0346A5] sm:text-[30px]">{t("terms.heading")}</h1>
      ...
      <div className="mt-6 space-y-5">
        {termsSections.map((section, i) => (
          <section key={i} className="rounded-2xl border border-[#E2E8EA] bg-white p-5">
            <h2 className="text-[15.5px] font-bold text-[#0346A5]">{pick(section.title)}</h2>
